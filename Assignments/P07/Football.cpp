...
//to store the each football team data
struct team{
	string name;//name of the team
	int goalScore;//to track the total goals
	int goalAgainst;//track against goals
	int win, tie, loss;
};
...
int main(){
	...
	while (t--){
		...
		getline(cin, tournamentName);//get the  team  discription
		
        int n, g; //n for number of teams nad g for goals
		cin >> n;


		(void)getchar();
        //get the each team details
		for (int i = 0; i < n; i++){
